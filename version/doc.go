...
//
// Wire documents (Index / Manifest) carry version+code in protobuf (rup.v2).
// This package owns the on-disk project file that those values come from, so
// hosts do not invent their own VERSION readers.
//
